  ...
  return (
    <>
      {!isOpen && (
        <button
          onClick={openEscort}
          className="fixed top-4 right-4 z-100 flex items-center gap-2 rounded-full bg-slate-900/90 px-4 py-3 text-white shadow-xl backdrop-blur-md border border-slate-700 hover:bg-slate-800 transition-all hover:scale-105 animate-in fade-in zoom-in duration-300"
        >
